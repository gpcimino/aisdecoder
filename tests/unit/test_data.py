...
message_3_1 = {
    ...
    "parsed": {"id": 3, "repeat_indicator": 0, "mmsi": 256720000, "nav_status": 0, 
               ...
               "sog": 0.10000000149011612, "position_accuracy": 1, "x": 9.831686666666666,
                 "y": 44.096696666666666, "cog": 360.0, "true_heading": 218, "timestamp": 57, 
                 "special_manoeuvre": 0, "spare": 0, "raim": True, "sync_state": 0, 
                 "slot_increment": 511, "slots_to_allocate": 0, "keep_flag": False}
}
...
#null true heading
message_1_3 = {
    "raw": "!AIVDM,1,1,,A,13cnPQ?P00Pfot2I62vh0?wh20Si,0*23",
    "parsed": {'id': 1, 'repeat_indicator': 0, 'mmsi': 247308420, 'nav_status': 15, 
               'rot_over_range': True, 
               'rot': -731.386474609375, 
               'sog': 0.0, 'position_accuracy': 1, 
               'x': 10.239788333333333, 'y': 43.85577833333333, 
               'cog': 0.0, 
               'true_heading': 511, 'timestamp': 56, 'special_manoeuvre': 0, 'spare': 0, 'raim': True, 'sync_state': 0, 'slot_timeout': 0, 'slot_offset': 2289}
}
